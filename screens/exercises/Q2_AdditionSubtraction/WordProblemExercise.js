...
const questions = [
  { question: "Juan has 5 apples. He buys 3 more. How many apples now?", options: ["7","8","9"], answer:"8" },
  { question: "Maria has 12 candies. She gives 4 to Ana. How many left?", options: ["7","8","9"], answer:"8" }
];

export default function WordProblemExercise() {
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor:"#4caf50", padding:15, borderRadius:10, marginBottom:10, width:"70%", alignItems:"center" },
